\chapter{PHP (partly READY FOR FEEDBACK, partly PROOFREAD)}
\label{php}\index{PHP}
...
PHP 5.4 introduced traits and dropped support for the \texttt{safe\_mode} and deprecated \texttt{register\_globals}. In addition, call-time pass by reference was removed.

...
Automated static code analysis tools that scan code for security vulnerabilities can help developers discover potential problems early in the development process---particularly, before any vulnerable code goes live. The open-source security vulnerability scanner \emph{Pixy} uses a tainted object-propagation scanning approach for finding cross-site scripting (XSS), SQL injection and file inclusion vulnerabilities. Pixy also includes a sophisticated alias analysis to increase precision and recall.
...
This thesis contributes a sound approach for conducting taint analysis for object field while taking object references into account.

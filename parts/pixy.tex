...
\hline
 unknown function call & a function call that can not be resolved during analysis & \texttt{CallUnknownFunction} \\
\hline
...
\hline
\end{tabular}
}{The main types of control-flow graph nodes in P-TAC as used by Pixy. The class names are within the package \texttt{at.ac.tuwien.infosys.www.pixy.conversion.cfgnodes}.}{table:p-tac}

...
The numbers in table~\ref{table:junit-before} on page~\pageref{table:junit-before} show the state of Pixy before and after the modifications. The code coverage has been determined using the EclEmma tool.~\cite{eclemma}
...
\hline
  Test failures & 1 & \\
\hline
  Code coverage (within \texttt{src/}) & 56.2\,\% & \\
\hline
\end{tabular}
